from labs.database.embeddings import Embedding, find_embeddings
from tests.constants import MULTIPLE_EMBEDDINGS, REPO, SINGLE_EMBEDDING
...
def test_find_embeddings_one_match(db_session, create_test_embedding):
    ...
    result = find_embeddings(db_session, REPO)
    assert result != []
...
def test_find_embeddings_multiple(db_session, create_test_embeddings):
